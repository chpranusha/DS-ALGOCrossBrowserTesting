...
public class StartPageStepDef extends BaseClass {
	...
	public void the_user_select_any_dropdown_menu(String string) throws Exception {
	...
	public void the_user_click_any_of_the_get_started_button_in_home_page(String string) {
